...
## <Icon icon="box" size="24" className="inline-block align-text-bottom" /> What is this feature?
...
## <Icon icon="check-square" size="24" className="inline-block align-text-bottom" /> Status Designations

<img height="600" src="/images/organizingworkspaces.jpeg" className="border border-gray-300 rounded-md shadow-sm" />

## <Icon icon="bar-chart-2" size="24" className="inline-block align-text-bottom" /> Workspace Before & After
...
## <Icon icon="zap" size="24" className="inline-block align-text-bottom" /> Tips for Using App Status
...
## <Icon icon="help-circle" size="24" className="inline-block align-text-bottom" /> FAQ
...
## <Icon icon="circle-message" size="24" className="inline-block align-text-bottom" /> We Want Your Feedback!

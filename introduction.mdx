...
<CardGroup cols={3}>
  <Card title="Camera Handwriting Input" color="#8b5cf6" icon="camera" href="/features/Camera Handwriting Input">
    Snap a photo of handwritten notes, equations, or diagrams and send them directly to the AI for interpretation and feedback.
  </Card>

  <Card title="Doc Editor" color="#3b82f6" icon="file-pen" href="/features/Doc Editor">
    Create, edit, and export documents directly inside your Playlab apps with AI-assisted writing.
  </Card>

  <Card title="Safety and Moderation Updates" color="#10b981" icon="shield-halved" href="/features/Safety and Moderation Updates">

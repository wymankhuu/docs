...
<Card title="Next Generation Science Standards (NGSS)" icon="flask-conical" href="https://www.nextgenscience.org/">
Three-dimensional science standards emphasizing scientific practices, crosscutting concepts, and disciplinary core ideas
</Card>

<Card title="WIDA ELD Standards" icon="messages-square" href="https://wida.wisc.edu/teach/standards/eld">
English Language Development standards supporting multilingual learners across content areas
</Card>

<Card title="WIDA Spanish Standards (Marco DALE)" icon="languages" href="https://wida.wisc.edu/">

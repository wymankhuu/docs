...
**Tier 2 Performance:** Claude Opus 4.6 (most thorough standards analysis but slower response times) and Kimi K2.5 (advanced tool usage with solid educational standards handling).

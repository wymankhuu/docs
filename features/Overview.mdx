...
<CardGroup>
  <Card title="Join our Slack" icon="hash" href="https://join.slack.com/t/playlabcommunity/shared_invite/zt-31mhwj7nl-49e1Mw5fYpyHJGOFyDIFtA" iconType="duotone">
    Connect with the Playlab community
  </Card>
  <Card title="Contact Support" icon="mail" href="mailto:support@playlab.ai" iconType="duotone">

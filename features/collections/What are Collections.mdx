...
{/* TODO-VID-WHAT-ARE-COLLECTIONS: Walkthrough video for what a Collection is and when to use one */}
<Frame caption="Walkthrough: what a Collection is and when to use one.">
  <iframe
    src="https://www.loom.com/embed/TODO-VID-what-are-collections"
    frameborder="0"

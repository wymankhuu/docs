...
<Frame caption="The Create Collection form. Name, description, and the Add Apps affordance.">
 <img src="/images/v2/v2_collection_create.png" alt="The V2 Create Collection form showing fields for name and description and an Add Apps button." />
</Frame>
...
<Frame caption="Sharing a Collection works the same as sharing an app: type the recipient, set permissions, send.">
 <img src="/images/v2/v2_collection_share.png" alt="The V2 Share Collection modal with a recipient field, permission selector, and Send button." />
</Frame>

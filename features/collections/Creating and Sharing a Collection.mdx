...
*How to build a Collection and share it.*
...
{/* VID-04: Collections walkthrough */}
<Frame caption="Walkthrough: create a Collection, add apps, share it with a partner organization.">
  <iframe
    src="https://www.loom.com/embed/TODO-VID-04"
    frameborder="0"
...
**What if an app inside a Collection is unpublished by its owner?**

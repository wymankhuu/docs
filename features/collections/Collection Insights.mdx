...
{/* IMG-COLL-INSIGHTS: Collection insights dashboard */}
<Frame caption="The Collection insights dashboard. Adoption, per-app usage, and recipient breakdown surface the questions that matter most.">
 <img src="/images/v2/TODO-collection-insights.png" alt="A Collection insights dashboard showing adoption stats at the top, a list of apps with usage sparklines, and a recipient org list with per-org usage summaries." />
</Frame>

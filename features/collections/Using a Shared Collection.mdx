...
{/* IMG-COLL-RECEIVED: Collections tab with shared Collections highlighted */}
<Frame caption="The Collections tab shows shared Collections alongside ones your org owns. The owner label tells you the source.">
 <img src="/images/v2/TODO-collection-received.png" alt="A V2 Collections tab listing both org-owned Collections and Collections shared with the org, with owner attribution on each card." />
</Frame>

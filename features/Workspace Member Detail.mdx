...
<Info>
  **Key points**
  ...
  - Visible to workspace managers and org admins only
</Info>
...
<Frame caption="The Members tab. Click any member to open their detail page.">
 <img src="/images/v2/v2_workspace_members_tab.png" alt="A V2 workspace Members tab listing students with click-through affordances." />
</Frame>

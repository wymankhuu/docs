...
<Info>
  **Key points**
  ...
  - Add the same app to as many workspaces as you need; no remixing
  - Activity is tracked separately in each workspace
  - Updates from the owner reach every workspace automatically
</Info>
...
<Frame caption="From the Apps tab, click Add Apps to bring an existing app into the workspace.">
 <img src="/images/v2/v2_add_app_to_workspace.png" alt="The V2 workspace Apps tab with an Add Apps modal open, showing a search field and selectable app cards." />
</Frame>

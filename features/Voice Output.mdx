...
<Accordion title="What languages are supported?">
  Voice output supports any language that your device's text-to-speech system supports. The available voices in Playlab will reflect your device's installed language options.
</Accordion>

<Accordion title="Can I change the voice?">
  Yes! You can select from the available voice options in Playlab's voice selection menu. The voices you see depend on what your device's operating system provides.
</Accordion>

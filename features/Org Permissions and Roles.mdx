...
<Info>
  **Key points**
  ...
  - Four roles cover most needs: Org Admin, Member, Workspace Manager, Viewer
...
<Frame caption="The role dropdown on a member's detail panel. Pick the role and the change applies immediately.">
 <img src="/images/v2/v2_org_role_dropdown.png" alt="A V2 organization Members tab with a role dropdown open showing the four role options." />
</Frame>

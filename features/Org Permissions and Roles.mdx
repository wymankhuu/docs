...
{/* TODO-VID-ORG-ROLES: Walkthrough video for org-level roles and how they cascade */}
<Frame caption="Walkthrough: org-level roles and how they cascade.">
  <iframe
    src="https://www.loom.com/embed/TODO-VID-org-roles"
    frameborder="0"
...
<AccordionGroup>
 ...
 Not in this release. The four roles cover the most common patterns. Custom role definition is on the roadmap.
 </Accordion>
 ...
 The apps stay with the original owner. Role changes affect what the member can do going forward. They do not transfer or delete existing apps.
  ...
  <Accordion title="Can I see who changed someone's role?">
    Yes. Each member's history shows role changes with timestamps and the admin who made each change.
  </Accordion>
  <Accordion title="Are role changes logged for audit?">
    Yes. Org admins can export the audit log from org settings. Useful for compliance reviews.
  </Accordion>
  <Accordion title="What's the difference between Admin and Workspace Manager in practice?">
    Admins see everything in the org. Managers see only the workspaces they manage. If someone needs visibility into other workspaces, they need Admin.
  </Accordion>
</AccordionGroup>

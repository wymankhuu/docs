...
description: "Execute Python code directly in your Playlab conversations for data analysis, file generation, computation, and so much more."
---
...
## <Icon icon="circle-play" size="24" /> Watch MCP Python Tool in Action

<Frame>
  <iframe
    src="https://drive.google.com/file/d/1M5dZxWXgAEaFhdV7O1CtA9onUabsomsN/preview"
    width="100%"
    height="480"
    allow="autoplay"
  />
...
## <Icon icon="diagram-project" size="24" /> What Can It Do?

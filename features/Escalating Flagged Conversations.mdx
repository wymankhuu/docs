...
When a message is automatically moderated (either input or output), the creator of the app will receive an email notification different from manually flagged conversations.
<img height="800" src="/images/escalatingflagged (2).png" className="border border-gray-300 rounded-md shadow-sm" />
...
<Steps>
  ...
  <Step title="Filter by Conversation Type">
    ...
    <img height="600" src="/images/escalatingflagged.png" alt="conversation type filter" className="border border-gray-300 rounded-md shadow-sm" />
  </Step>

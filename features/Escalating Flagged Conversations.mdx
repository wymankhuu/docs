...
When a message is automatically moderated, the app creator, workspace owner, and organization admin will receive an email notification different from manually flagged conversations.![image.png](/image.png)

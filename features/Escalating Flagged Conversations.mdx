...
sidebarTitle: "Escalating Flagged Conversations Guide"
---
...
### Builder Test Conversations

Conversations you have while testing your own app in **Builder preview mode** also appear in the Activity view, alongside end-user conversations. Any moderated or flagged messages from those test sessions are reviewable the same way. This means you can:

- Spot moderation issues during testing, before you share the app
- Iterate on your app's instructions when your own test prompts trigger flags
- Keep a complete audit trail of every conversation your app has participated in
...
<Icon icon="circle-question-mark" size="24" /> FAQ
...
<Icon icon="megaphone" size="24" /> We Want Your Feedback\!

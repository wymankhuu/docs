...
<CardGroup cols={2}>
  <Card title="Avoid Blurry Images" icon="photo">
  ...
  <Card title="Write in Bold, Clear Lines" icon="pencil">
  ...
  <Card title="Add Context in Your Message" icon="message">
...
<CardGroup cols={2}>
  <Card title="Gemini 3.1 Pro" icon="robot">

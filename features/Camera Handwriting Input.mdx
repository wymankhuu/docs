...
sidebarTitle: "Camera Handwriting Input"
tag: "Beta"
---
...
<CardGroup cols={2}>
  ...
  <Card title="One Section at a Time" icon="target">
  ...
  <Card title="Add Context in Your Message" icon="message-square">

---
title: "Publishing your app in V2"
description: "How to publish a Playlab app in V2, set visibility, and share with specific recipients."
sidebarTitle: "Publishing"
icon: "paper-plane"
---

*How to publish a Playlab app and pick who can use it.*

Publishing makes an app available beyond the people you have shared it with directly. In V2, you publish from the app builder or from any app's Share modal, set the visibility level, and optionally share with specific people, groups, or organizations in the same flow.
...
<Frame caption="The Share modal includes the Publish toggle and the visibility selector in one place.">
  <img src="/images/v2_share_modal_publish.png" alt="The V2 Share modal with a Publish toggle, visibility selector, and recipient picker visible together." />
</Frame>
...
<Frame caption="Share with a specific person, group, or organization. The visibility level still controls who else can find the app.">
  <img src="/images/v2_share_modal_individual.png" alt="The V2 Share modal with an email entered and a permission dropdown showing Editor and Viewer options." />
</Frame>
...
**Can I monetize a published app?**
...
**Can I share a draft before publishing?**
...
**Did the workspace-only visibility level go away?**

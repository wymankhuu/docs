...
<Steps>
<Step title="Enable Voice Input at Organization Level">
    ...
    <Frame>
      ![Organization settings toggle for voice input](/images/voiceinputtoggle.png)
    </Frame>
  </Step>
  
  <Step title="Enable Voice Input in App Builder">
    In the app builder settings, toggle on "Allow Voice Input" to enable voice input functionality for your specific app.

    <Frame>
      ![App builder settings toggle for voice input](/images/allowvoiceinput.png)
    </Frame>
  </Step>

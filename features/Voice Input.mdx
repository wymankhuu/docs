...
Once the microphone icon turns blue with a glowing ring animation, you're actively recording. Simply start speaking naturally, the transcription will appear in real-time in the chat input field.
<Frame>

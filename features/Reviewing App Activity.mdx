...
<Frame>
  <img src="/images/app activity.png" alt="App Navigation Tabs showing Build, Design, and Activity" className="bordered-image" />
</Frame>
</Step>
...
<Frame>
  <img src="/images/customcriteria.png" alt="Configure Conversation Review setup screen" className="bordered-image" />
</Frame>
</Step>
</Steps>
...
<Frame>
  <img src="/images/goalmet.png" alt="Conversation Review Settings showing goal analysis results with GOAL MET and GOAL NOT MET examples" className="bordered-image" />
</Frame>
<Frame>
  <img src="/images/goalnotmet.png" alt="Conversation Review Settings showing goal analysis results with GOAL MET and GOAL NOT MET examples" className="bordered-image" />
</Frame>
</Step>
...
3. Monitor user retention and return visit rates
4. Track the overall health and performance of your app
</Step>
...
- **Low-engagement areas**: Redesign or remove features that aren't being used
- **Common user paths**: Streamline and optimize the most popular workflows
- **Drop-off points**: Add guidance, simplify processes, or provide better onboarding
...
- **Usage statistics**: Sessions, unique users, conversation counts, and duration
- **Engagement metrics**: Message depth, completion rates, and return visits
- **Feature analytics**: Which tools and functions are used most frequently
- **Performance data**: Response times, error rates, and system health
- **Content insights**: Types of output generated and user satisfaction
- **User behavior**: Common paths, drop-off points, and interaction patterns
</Accordion>

<Accordion title="Can I compare my app's performance to benchmarks?">
Currently, Playlab provides your app's historical performance data for comparison over time. Industry benchmarks or anonymous aggregate comparisons are not yet available, but may be added in future updates. Focus on improving your app's performance relative to its own historical data and user feedback.
</Accordion>
...
- **Anonymous insights**: All data is anonymized to protect user privacy

You get rich behavioral insights without compromising individual user privacy.
</Accordion>

<Accordion title="Can I set up alerts for individual app performance?">
Yes, you can configure notifications for key metrics specific to your app:

- **Usage thresholds**: Get notified when activity drops or spikes significantly
- **Error rate alerts**: Immediate notifications for technical issues
- **Performance degradation**: Alerts when response times increase
- **Engagement changes**: Notifications about significant changes in user behavior

These alerts help you stay on top of your app's health and performance.
</Accordion>

...
Watch a short demonstration of how to access and review individual app activity in Playlab.
  ...
  />
  <figcaption>How to review individual app activity</figcaption>
...
<Card title="Workspace Activity Review" icon="chart-mixed" href="/getstarted/Reviewing Activity">
  Looking for an overview of activity across all your apps? Check out the Workspace Activity Review guide for filtering, trends, and workspace-level analytics.
</Card>

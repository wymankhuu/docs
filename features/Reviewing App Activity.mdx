...
<Frame caption="The org-level dashboard. Usage across every workspace, with filters for workspace, app, member, and date.">
 <img src="/images/v2/v2_org_activity_dashboard.png" alt="A V2 organization-level dashboard showing usage stats across workspaces with filter controls." />
</Frame>
...
<Frame caption="The centralized flagged messages list. Filter by workspace, severity, member, or date.">
 <img src="/images/v2/v2_flagged_messages_dashboard.png" alt="A V2 centralized flagged messages dashboard listing flags across workspaces with severity indicators." />
</Frame>

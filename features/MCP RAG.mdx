...
sidebarTitle: "Improving Referencing with Agentic Search Tool"
---
...
**Tier 1 Performance (Recommended):** Claude Sonnet 4.6 (excellent balance of search accuracy and response quality), GPT 5.4 (superior for complex document analysis and precise retrieval), and Gemini 3.1 Pro (high accuracy with comprehensive document understanding).

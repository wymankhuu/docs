...
## <Icon icon="key" size="24" className="inline-block align-text-bottom" /> Status Designations

<img height="600" src="/images/organizingworkspaces.jpeg" className="border border-gray-300 rounded-md shadow-sm" />

## <Icon icon="eye" size="24" className="inline-block align-text-bottom" /> Workspace Before & After
...
## <Icon icon="message-circle" size="24" className="inline-block align-text-bottom" /> We Want Your Feedback!

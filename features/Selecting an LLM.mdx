...
| Examples: Claude 4 models, GPT-4 series, Gemini models | Examples: Llama models, DeepSeek R1, GPT OSS models, Kimi K2 | Coming soon! |
...
<Accordion title="Ask yourself what is an ideal response time for your app?">
  This will allow you to pick larger or smaller models that meet those needs. Claude 4 Sonnet offers the best balance, while Claude 4 Opus prioritizes quality over speed. Gemini 2.5 Flash excels at speed for simple tasks.
</Accordion>

<Accordion title="Identify what complexity level is your task?">
  * For simple Q&A or content generation, lighter models like Gemini 2.5 Flash or Claude 3.5 Haiku may suffice
  * For balanced everyday tasks, Claude 4 Sonnet or GPT-4o are ideal
  * For the most complex multi-step reasoning, choose Claude 4 Opus, o3 Mini, Gemini 2.5 Pro, or reasoning-focused models
</Accordion>

<Accordion title="What is the level of accuracy you are requiring of your app?">
  * Critical accuracy use cases like data analysis, or HR operations might require Claude 4 Opus, Gemini 2.5 Pro, or other powerful models even if they're slower.
  * Use cases that require creativity or open ended responses work well with Claude 4 Sonnet, GPT-4o, or creative-focused models.
</Accordion>
...
<Accordion title="Do you need open weights or source code access?">
  ...
  * For maximum performance and latest capabilities, frontier models like Claude 4 series, GPT-4.1, or Gemini 2.5 series are typically best
...
<Accordion title="Try to match your model with your use case:">
  * **Everyday applications** – Claude 4 Sonnet or GPT-4o provide the best balance of performance and efficiency
  * **Critical/Complex applications** – Claude 4 Opus, Gemini 2.5 Pro, or o3 Mini for highest accuracy and reasoning capability
  * **Creative applications** – Claude 4 Sonnet, GPT-4o, or GPT-4.1 for creative tasks
  * **Problem-solving tools** – Claude 4 Opus, o3 Mini, Gemini 2.5 Pro, or Llama 4 Maverick
  * **Document analysis** – Claude 4 Opus or Llama 4 Scout for multi-document or cross-lingual analysis
  * **Technical/Coding tasks** – GPT-4.1, Claude 4 Opus, or Kimi K2 for tool usage
  ...
  * **High-volume applications** – Balance quality with speed using Claude 4 Sonnet, Gemini 2.5 Flash, or GPT-4.1 Nano
  * **Budget-conscious applications** – DeepSeek R1 or open weight models for cost-effective solutions
...
<Accordion title="Additional best practices:">
  ...
  * If you're building a suite of apps we recommend you use faster models for simple queries and reserve powerful models like Claude 4 Opus or Gemini 2.5 Pro for complex tasks
  * Consider cost implications - newer frontier models may be more expensive but offer better performance

...
<div className="bg-blue-500 text-white px-6 py-4 rounded-lg mb-6 shadow-lg">
  <div className="flex items-center">
    ...
    <span className="font-semibold">🎉 NEW: <code className="bg-white/20 px-2 py-1 rounded text-sm">GPT-5</code>, <code className="bg-white/20 px-2 py-1 rounded text-sm">GPT-5 Mini</code>, and <code className="bg-white/20 px-2 py-1 rounded text-sm">GPT-5 Nano</code> are now available in Playlab!</span>
  </div>
</div>
...
<Accordion title="Try to match your model with your use case:">
  * **Everyday applications** – Claude 4 Sonnet, GPT-5 Mini, or GPT-4o provide the best balance of performance and efficiency
  * **Critical/Complex applications** – GPT-5, Claude 4 Opus, Gemini 2.5 Pro, or o3 Mini for highest accuracy and reasoning capability
  * **Creative applications** – GPT-5, GPT-5 Mini, Claude 4 Sonnet, GPT-4o, or GPT-4.1 for creative tasks
  * **Problem-solving tools** – GPT-5, Claude 4 Opus, o3 Mini, Gemini 2.5 Pro, or Llama 4 Maverick
  * **Document analysis** – Claude 4 Opus or Llama 4 Scout for multi-document or cross-lingual analysis
  * **Technical/Coding tasks** – GPT-5, GPT-4.1, Claude 4 Opus, or Kimi K2 for tool usage
  * **Educational explanation** – GPT-5 Mini, Claude 4 Sonnet, Llama 3.3 70B Instruct, Llama 4 Maverick, or those with strong explanatory capabilities
  * **High-volume applications** – Balance quality with speed using GPT-5 Nano, Claude 4 Sonnet, Gemini 2.5 Flash, or GPT-4.1 Nano

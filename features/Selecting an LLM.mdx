...
<Accordion title="Can I use different models for different parts of my app suite?">
  Yes! We recommend using faster models like Claude Haiku 4.5 for simple queries and reserving more powerful models like Claude Opus 4.6, Claude Sonnet 4.6, GPT 5.2, Gemini 3.1 Pro, or Claude 4 Sonnet (Reasoning) for complex tasks if you're building a suite of apps.
</Accordion>

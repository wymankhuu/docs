...
<CardGroup cols={2}>
  <Card title="Claude Opus 4.6 (Anthropic)" icon="crown">
    ...
    <p><strong>Plus Strengths:</strong> Unmatched intelligence and reasoning depth. Superior performance on complex multi-step problems. Exceptional analytical and coding capabilities. Best-in-class for higher-order math and extended tasks.</p>
  ...
  <Card title="Claude Sonnet 4.6 (Anthropic)" icon="diamond">
    ...
    <p><strong>Plus Strengths:</strong> Highest intelligence across most tasks. Superior instruction following and nuance understanding. Exceptional balance of speed and capability. Best-in-class for most applications requiring high quality output.</p>
  ...
  <Card title="Claude Haiku 4.5 (Anthropic)" icon="leaf">
    ...
    <p><strong>Plus Strengths:</strong> Blazing fast response times with extended thinking capabilities. Near-frontier intelligence at exceptional cost-efficiency. Excellent for quick questions and lightweight tasks.</p>
  ...
  <Card title="GPT 5.2 (OpenAI)" icon="circle-star">
    ...
    <p><strong>Plus Strengths:</strong> State-of-the-art coding and reasoning performance. Exceptional problem-solving capabilities. Superior instruction following and nuance understanding.</p>
  ...
  <Card title="GPT-5 Mini (OpenAI)" icon="circle-star">
    ...
    <p><strong>Plus Strengths:</strong> Fast response times for well-defined tasks. Cost-effective for regular applications. Strong performance across most tasks without premium overhead.</p>
  ...
  <Card title="Gemini 3.1 Pro (Google)" icon="stars">
    ...
    <p><strong>Plus Strengths:</strong> Maximum response accuracy and state-of-the-art performance. Exceptional reasoning and problem-solving. Superior performance on complex analytical tasks. Enhanced creative and coding capabilities. Best-in-class for applications requiring advanced Google AI.</p>
  ...
  <Card title="Gemini 2.5 Flash (Google)" icon="bolt">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Previous version of Google's general purpose model optimized for fast response times.</p>
  ...
  <Card title="Llama 4 Maverick (Meta)" icon="meta">
    ...
    <p><strong>Plus Strengths:</strong> Strong reasoning capabilities for math and general knowledge. Open weight benefits. Good performance across diverse tasks.</p>
  ...
  <Card title="Qwen 3 (Alibaba)" icon="sparkles">
    ...
    <p><strong>Plus Strengths:</strong> Excellent multilingual support. Strong performance on reasoning and instruction following tasks. Good balance of performance and efficiency. Open weight flexibility.</p>
...
<Accordion title="What's the difference between GPT 5.2 and GPT-5 Mini?">

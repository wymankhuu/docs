...
<CardGroup cols={2}>
  ...
  <Card title="GPT-5 Mini (OpenAI)" icon="circle-star">
    ...
    <p><strong>Trade Offs:</strong> Slightly reduced capabilities compared to GPT 5.2. May not excel at the most complex reasoning challenges requiring maximum model capacity.</p>
  </Card>
  ...
  <Card title="Gemini 2.5 Flash (Google)" icon="bolt">
    ...
    <p><strong>Trade Offs:</strong> Not ideal for multi-step problem solving or complex instruction following. Superseded by Gemini 3 Flash for most use cases.</p>
  </Card>

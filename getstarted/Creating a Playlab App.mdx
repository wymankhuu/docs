...
## <Icon icon="frequently-asked-questions" size="24" className="inline-block align-text-bottom" /> Frequently Asked Questions

<Accordion>
  <AccordionItem title="How many apps can I create?">
    There is no limit to the number of apps you can create in your Playlab workspace.
  </AccordionItem>
  
  <AccordionItem title="Can I collaborate with others on an app?">
  ...
  <AccordionItem title="How do I update my app after publishing?">
  ...
  <AccordionItem title="What if my app doesn't work as expected?">
...
<CardGroup>
  ...
  <Card title="Signing Up for Playlab" icon="user-plus" href="/getstarted/signing-up" iconType="duotone">

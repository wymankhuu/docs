...
<Steps>
  ...
  <Step title="Explore the Playlab Interface">
    ...
    1️⃣ Title bar | 2️⃣ Model select bar | 3️⃣ App Preview 

    4️⃣ Playlab Builder | 5️⃣ Builder Toolbar | 6️⃣ Publish
  </Step>
  ...
  <Step title="Write Your AI Instructions">
    ...
    2. Now let's get started on the **Workflow** section of your prompt:
       - The workflow section is where you will guide your AI by telling it the steps you want the AI to take as it is interacting with the user.
          ...
          - <Note>You can have as many or as few steps as you need.</Note>
    ...
    4. 🎉 **Congrats!** You've just created a prototype of an AI app in Playlab
       ...
       <Frame>
         <img src="/images/builder.jpeg" alt="Builder" width="300" />
       </Frame>
  </Step>
...
<Tabs>
  ...
  <Tab title="Common Pitfalls">
    * Giving vague instructions to the AI
    * Creating overly complex directions without testing
    * Not providing enough context in your prompts
    * Forgetting to test with different types of inputs
    * Publishing before thorough testing
  </Tab>
</Tabs>

<Icon icon="bullhorn" size="24" className="inline-block align-text-bottom" /> Frequently Asked Questions
...
<CardGroup>
  ...
  <Card title="Adding Members to Playlab" icon="user-plus" href="/getstarted/Adding Members to your Workpspace" iconType="duotone">

...
<CardGroup>
  ...
  <Card title="Adding Members to Your Workspace" icon="user-plus" href="/getstarted/add-members" iconType="duotone">
    Learn how to invite team members to your workspace
  </Card>
</CardGroup>

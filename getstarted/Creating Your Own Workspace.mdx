...
<Info>
  **Key points**
  ...
  - Set building permissions when you create them; change anytime
...
<Frame caption="The New Workspace form. Name, description, and building permissions are set together.">
 <img src="/images/v2/v2_workspace_create_form.png" alt="The V2 New Workspace form with fields for name, description, and three building permissions toggles visible." />
</Frame>
...
<Frame caption="From the Apps tab, click Add Apps to bring an existing app into your workspace.">
 <img src="/images/v2/v2_add_app_to_workspace.png" alt="The V2 workspace Apps tab with an Add Apps modal open, showing a list of apps to choose from." />
</Frame>

...
<Info>
  **Key points**
  ...
  - Three toggles: members can build, see each other's work, share beyond workspace
  - Defaults are conservative; turn on as the class needs grow
...
<Frame caption="The three building permission toggles. All start off. Turn on the ones the class needs.">
 <img src="/images/v2/v2_workspace_building_permissions.png" alt="A V2 workspace settings panel showing three toggles for building permissions: build apps, see each other, share beyond workspace." />
</Frame>

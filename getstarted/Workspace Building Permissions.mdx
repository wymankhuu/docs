...
{/* TODO-VID-BUILDING-PERMISSIONS: Walkthrough video for the three building permission toggles */}
<Frame caption="Walkthrough: the three building permission toggles.">
  <iframe
    src="https://www.loom.com/embed/TODO-VID-building-permissions"
    frameborder="0"
...
<AccordionGroup>
 ...
 Org-level policies take precedence. If the org disables public sharing, the workspace toggle for "share beyond workspace" still works for in-org sharing, but public visibility is unavailable.
  ...
  <Accordion title="What's the safest default for a brand-new class?">
    All three toggles off. Turn on Build apps when students are ready to create. Add See each other when collaboration becomes part of the lesson. Keep Share beyond off unless you've talked through what students might share.
  </Accordion>
  <Accordion title="Can I lock permissions so other managers can't change them?">

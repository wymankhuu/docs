...
<Frame caption="The organization dashboard: Workspaces, Apps, Collections, and Members are the four primary tabs.">
 <img src="/images/v2/v2_org_dashboard.png" alt="Annotated screenshot of the organization dashboard showing the Workspaces, Apps, Collections, and Members tabs along the top navigation." />
</Frame>

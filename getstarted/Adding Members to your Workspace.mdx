...
<CardGroup>
  <Card title="Back to Getting Started" icon="arrow-left" href="/getstarted/index" iconType="duotone">
    Return to getting started guide
  </Card>
  <Card title="Publishing your Playlab App" icon="input-text" href="/getstarted/publishing" iconType="duotone">
    Learn how to enhance your app with starter inputs
  </Card>
</CardGroup>

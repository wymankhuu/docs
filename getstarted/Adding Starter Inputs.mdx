...
Watch a short clip of how to add starter inputs to your Playlab app.
<Frame>
  <img src="/images/Richer Starter Inputs.gif" alt="Richer Starter Inputs" className="bordered-image" />
</Frame>
...
<CardGroup>
  <Card title="Back to Building Your First App" icon="arrow-left" href="/getstarted/first-app" iconType="duotone">
    Return to previous documentation
  </Card>

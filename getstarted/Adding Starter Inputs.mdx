---
title: 'Adding Richer Starter Inputs'
...
<Accordion title="Why should I use dropdown inputs instead of text inputs?">
...
<CardGroup>
  <Card title="Back to Building Your First App" icon="arrow-left" href="/getstarted/first-app" iconType="duotone">
    Go back to the beginning
  </Card>
  <Card title="Using the Playlab Assistant" icon="robot" href="/getstarted/Using the Playlab Assistant" iconType="duotone">
    Learn how to use the Playlab Assistant
  </Card>
</CardGroup>

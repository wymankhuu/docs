...
<Info>
  **Reference Benefits**
  ...
  Adding references to your app:
  - Ensures AI responses align with specific, verified information
  - Tailors content to your exact curriculum or teaching standards
  - Provides AI with rich context for more comprehensive responses
  - Allows incorporation of up-to-date information
  - Enables creation of unique, school-specific or organizational content
</Info>
  ...
  <Step title="Add References">
    **Choose your reference type.**
    ...
    2. Select from these reference options:
       - **File Upload**: Upload documents directly from your computer
...
<Warning>Maximum file size for uploaded references is 30 MB</Warning>
...
<Accordion title="What types of files can I upload as references?">
  Playlab supports various reference formats including PDF, DOCX, TXT, CSV, JSON, and XLSX files. The maximum file size for uploaded references is 30 MB.
</Accordion>

<Accordion title="How many references should I add to my app?">
  Start with 3-5 core references that cover your app's main functionality. Quality is more important than quantity. Each reference should have a clear purpose and improve your app's output.
</Accordion>
...
<CardGroup>
  ...
  <Card title="Adding Starter Inputs" icon="input-text" href="/getstarted/Adding Starter Inputs" iconType="duotone">
    Learn how to add Starter Inputs
  </Card>
</CardGroup>

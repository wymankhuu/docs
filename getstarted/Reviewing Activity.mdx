...
description: 'Learn how to monitor usage and analyze app engagement in your workspace'
---
...
## <Icon icon="link" size="24" className="inline-block align-text-bottom" /> Related

<Card title="Individual App Activity Review" icon="magnifying-glass" href="/features/Reviewing App Activity">
  Want to dive deeper into a specific app's performance? Check out the Individual App Activity Review feature for conversation-level insights and AI-powered analysis.
</Card>

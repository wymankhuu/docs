...
## <Icon icon="calendar" size="24" className="inline-block align-text-bottom" /> May 14, 2026
...
## <Icon icon="calendar" size="24" className="inline-block align-text-bottom" /> April 29, 2026
...
Playlab now meets **WCAG 2.0 AA** accessibility standards across the platform. We've added visible focus indicators throughout the interface and accessible labels on every icon button, making Playlab significantly easier to navigate by keyboard and with screen readers.

> [Learn more about Accessibility in Playlab](/faq/Accessibility)

## <Icon icon="calendar" size="24" className="inline-block align-text-bottom" /> April 14, 2026
...
## <Icon icon="calendar" size="24" className="inline-block align-text-bottom" /> April 6, 2026
...
## <Icon icon="calendar" size="24" className="inline-block align-text-bottom" /> April 3, 2026
...
<Frame>
  <img src="/images/selfharmnotification.png" alt="Self-harm notification alert" />
</Frame>
...
<Frame>
  <img src="/images/safetynotifications.png" alt="Safety Notifications onboarding modal" />
</Frame>
...
<Frame>
  <img src="/images/doceditorinbuilder.png" alt="Doc Editor in Builder preview" />
</Frame>

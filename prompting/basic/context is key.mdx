...
<CardGroup cols={2}>
  <Card title="Shallow Context" icon="x" color="#f44336">
    **Example Prompt:** 
...
<CardGroup cols={2}>
  <Card title="Role Specification" icon="briefcase" color="#2196F3">
  ...
  <Card title="Communication Style" icon="message-dots" color="#FF9800">
    • Tone (formal/casual)
  ...
  <Card title="Outcome Alignment" icon="target" color="#9C27B0">
    • Specific goals

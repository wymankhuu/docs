...
sidebarTitle: "Negative Prompting"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Watch for Double Negatives" icon="triangle-alert" color="#2196F3">
  ...
  <Card title="Apply the Funnel Approach" icon="funnel" color="#FF9800">

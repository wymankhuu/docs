...
sidebarTitle: "Tailor Tool for Audience"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Adjust Complexity" icon="layers" color="#2196F3">
  ...
  <Card title="Test with Real Users" icon="flask-conical" color="#9C27B0">

...
sidebarTitle: "Be Mindful of Bias"
---
...
<Note> Remember, if AI is trained on biased information, it can output biased information. </Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Recognize Different Types of Bias" icon="eyeglass" color="#2196F3">
  ...
  <Card title="Be Explicitly Inclusive" icon="heart-handshake" color="#9C27B0">

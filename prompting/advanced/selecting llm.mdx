...
<div className="bg-blue-500 text-white px-6 py-4 rounded-lg mb-6 shadow-lg">
  <div className="flex items-center">
    ...
    <span className="font-semibold">🎉 NEW: <code className="bg-white/20 px-2 py-1 rounded text-sm">Claude Sonnet 4.5</code>, <code className="bg-white/20 px-2 py-1 rounded text-sm">Claude Haiku 4.5</code>, and <code className="bg-white/20 px-2 py-1 rounded text-sm">Qwen 3</code> are now available in Playlab!</span>
  </div>
</div>

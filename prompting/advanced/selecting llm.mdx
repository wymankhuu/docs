...
<div className="bg-blue-500 text-white px-6 py-4 rounded-lg mb-6 shadow-lg">
  <div className="flex items-center">
    ...
    <span className="font-semibold">🎉 NEW: <code className="bg-white/20 px-2 py-1 rounded text-sm">Claude Sonnet 4.5</code>, <code className="bg-white/20 px-2 py-1 rounded text-sm">Claude Haiku 4.5</code>, and <code className="bg-white/20 px-2 py-1 rounded text-sm">Qwen3</code> are now available in Playlab!</span>
  </div>
</div>
...
You can now build on top of even more LLMs in Playlab! There are now over 30 available AI models for you to build your Playlab apps on top of. We will try our best to always provide the latest models for you to build on top of.
...
| Examples: Claude 4 models, GPT-5 series, GPT-4 series, Gemini models | Examples: Llama models, DeepSeek R1, GPT OSS models, Kimi K2, Qwen3 | Coming soon! |
...
<CardGroup cols={2}>
  ...
  <Card title="Claude 4.5 Haiku (Anthropic)" icon="leaf">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
  ...
  <Card title="Claude 4.5 Opus (Anthropic)" icon="crown">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Latest version of Claude Opus series. Advanced model for complex analysis, even longer tasks with many steps, and higher-order math and coding.</p>
    <p><strong>Plus Strengths:</strong> Maximum capability and accuracy. Best for the most complex reasoning tasks requiring highest quality output.</p>
    <p><strong>Minus Trade Offs:</strong> Slower response times and higher cost. May be unnecessary for straightforward tasks.</p>
  </Card>

  <Card title="Claude 4.5 Sonnet (Anthropic)" icon="diamond">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model | Default</div>
    <p><strong>Description:</strong> Latest version of Claude Sonnet series with the highest intelligence across most tasks. This is the default model for new apps.</p>
  ...
  <Card title="Gemini 2.5 Flash Preview (Google)" icon="bolt">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Preview version of Gemini 2.5 Flash with latest features and improvements.</p>
    <p><strong>Plus Strengths:</strong> Access to latest Flash improvements. Fast response times with enhanced capabilities.</p>
    <p><strong>Minus Trade Offs:</strong> Preview version may have occasional instability. Not recommended for production-critical applications.</p>
  </Card>

  <Card title="Gemini 2.5 Pro (Google)" icon="crown">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Previous version of Google's most powerful thinking model.</p>
    <p><strong>Plus Strengths:</strong> Strong reasoning capabilities. High accuracy on complex tasks. Advanced problem-solving abilities.</p>
    <p><strong>Minus Trade Offs:</strong> Slower response times. Higher computational cost. Superseded by Gemini 3 Pro.</p>
  </Card>

  <Card title="Gemini 3 Pro (Google)" icon="crown">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    ...
    <p><strong>Plus Strengths:</strong> Exceptional reasoning capabilities. Highest accuracy on complex tasks. Latest Google AI advancements.</p>
  ...
  <Card title="GPT 5 (OpenAI)" icon="circle-star">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Previous version of OpenAI's reasoning model.</p>
    <p><strong>Plus Strengths:</strong> Strong performance across all domains. Good reasoning and problem-solving. Reliable instruction following.</p>
    <p><strong>Minus Trade Offs:</strong> Superseded by GPT 5.1 for most use cases.</p>
  </Card>

  <Card title="GPT 5 Mini (OpenAI)" icon="circle-star">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Faster model for well-defined tasks.</p>
    <p><strong>Plus Strengths:</strong> Excellent balance of GPT-5 capabilities with faster response times. Cost-effective for regular applications.</p>
    <p><strong>Minus Trade Offs:</strong> Slightly reduced capabilities compared to full GPT-5.</p>
  </Card>

  <Card title="GPT 5 Nano (OpenAI)" icon="circle-star">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> Cost-efficient model for well-defined tasks.</p>
    <p><strong>Plus Strengths:</strong> Fastest response times in the GPT-5 family. Most cost-effective for high-volume usage.</p>
    <p><strong>Minus Trade Offs:</strong> Limited capabilities compared to larger GPT-5 variants.</p>
  </Card>

  <Card title="GPT 5.1 (OpenAI)" icon="circle-star">
    <div className="text-xs bg-blue-100 px-2 py-1 rounded mb-2 inline-block">Frontier Model</div>
    <p><strong>Description:</strong> OpenAI's latest coding and reasoning model.</p>
    <p><strong>Plus Strengths:</strong> State-of-the-art performance across all domains. Exceptional reasoning and problem-solving. Advanced creative capabilities. Superior instruction following.</p>
    <p><strong>Minus Trade Offs:</strong> Slower response times and higher cost. May be unnecessary for simple tasks.</p>
  </Card>
  ...
  <Card title="Qwen3 (Alibaba)" icon="sparkles">
    <div className="text-xs bg-green-100 px-2 py-1 rounded mb-2 inline-block">Open Weight Model</div>
...
<Accordion title="Ask yourself what is an ideal response time for your app?">
  This will allow you to pick larger or smaller models that meet those needs. Claude Sonnet 4.5, Claude 4 Sonnet and GPT-5 Mini offer excellent balance, while Claude 4.5 Opus and GPT 5.1 prioritize quality over speed. Claude 4.5 Haiku, Gemini 2.5 Flash and GPT-5 Nano excel at speed for simple tasks.
</Accordion>

<Accordion title="Identify what complexity level is your task?">
  For simple Q&A or content generation, lighter models like Claude 4.5 Haiku, Gemini 2.5 Flash, Claude 3.5 Haiku, or GPT-5 Nano may suffice. For balanced everyday tasks, Claude Sonnet 4.5, Claude 4 Sonnet, GPT-5 Mini, or GPT-4o are ideal. For the most complex multi-step reasoning, choose GPT 5.1, Claude 4.5 Opus, o3 Mini, Gemini 3 Pro, or reasoning-focused models.
</Accordion>

<Accordion title="What is the level of accuracy you are requiring of your app?">
  Critical accuracy use cases like data analysis, or HR operations might require GPT 5.1, Claude Sonnet 4.5, Claude 4.5 Opus, Gemini 3 Pro, or other powerful models even if they're slower. Use cases that require creativity or open ended responses work well with GPT 5.1, GPT-5 Mini, Claude Sonnet 4.5, Claude 4 Sonnet, GPT-4o, or creative-focused models.
</Accordion>

<Accordion title="Do you need open weights or source code access?">
  If you need model customization, local deployment, or transparency into model operations, consider open weight models like Llama 4 series, Qwen3, DeepSeek R1, or GPT OSS models. For maximum performance and latest capabilities, frontier models like GPT 5.1 series, Claude Sonnet 4.5, Claude 4 series, GPT-4.1, or Gemini series are typically best. Consider your long-term deployment and customization needs when choosing between proprietary and open models.
</Accordion>
...
<Accordion title="Try to match your model with your use case:">
  Everyday applications: Claude Sonnet 4.5, Claude 4 Sonnet, Claude 4.5 Haiku, GPT-5 Mini, or GPT-4o provide the best balance of performance and efficiency. Critical/Complex applications: Claude Sonnet 4.5, GPT 5.1, Claude 4.5 Opus, Gemini 3 Pro, or o3 Mini for highest accuracy and reasoning capability. Creative applications: GPT 5.1, GPT-5 Mini, Claude Sonnet 4.5, Claude 4 Sonnet, GPT-4o, or GPT-4.1 for creative tasks. Problem-solving tools: Claude Sonnet 4.5, GPT 5.1, Claude 4.5 Opus, o3 Mini, Gemini 3 Pro, or Llama 4 Maverick. Document analysis: Claude Sonnet 4.5, Claude 4.5 Opus or Llama 4 Scout for multi-document or cross-lingual analysis. Technical/Coding tasks: Claude Sonnet 4.5, GPT 5.1, GPT-4.1, Claude 4.5 Opus, or Kimi K2 for tool usage. Educational explanation: Claude Sonnet 4.5, GPT-5 Mini, Claude 4 Sonnet, Llama 3.3 70B Instruct, Llama 4 Maverick, or those with strong explanatory capabilities. High-volume applications: Balance quality with speed using Claude Sonnet 4.5, Claude 4.5 Haiku, GPT-5 Nano, Claude 4 Sonnet, Gemini 2.5 Flash, or GPT-4.1 Nano. Budget-conscious applications: Claude 4.5 Haiku, GPT-5 Nano, Qwen3, DeepSeek R1 or open weight models for cost-effective solutions. Research/Experimentation: Open weight models like Llama 4 series, Qwen3, or GPT OSS models for flexibility.
</Accordion>

<Accordion title="Test out multiple models for apps that you are building:">
  Changing a model may change performance of an app in Playlab. Test multiple models before finalizing, as performance can vary significantly on your specific tasks. Implement A/B testing as you're building and testing to continually evaluate model performance. Consider starting with Claude Sonnet 4.5 as your baseline for most applications (it's the default for new apps). Test both frontier and open weight models to find the best fit for your needs.
</Accordion>

<Accordion title="Additional best practices:">
  We recommend that you remix apps as you're experimenting to not impact the original app. You can review activity to see how multiple models handle similar tasks. If you're building a suite of apps we recommend you use faster models like Claude 4.5 Haiku for simple queries and reserve powerful models like Claude Sonnet 4.5, GPT 5.1, Claude 4.5 Opus or Gemini 3 Pro for complex tasks. Consider cost implications, as newer frontier models like Claude Sonnet 4.5 and GPT 5.1 may be more expensive but offer better performance. For production apps requiring customization, evaluate open weight models like Qwen3 alongside frontier options. Keep track of which models work best for your specific use cases to build your own selection guidelines.
</Accordion>
...
<Accordion title="How do I know which model is best for my specific use case?">
  We recommend experimenting with different models for your specific use case. Consider factors like response time requirements, complexity level of tasks, accuracy needs, and whether you need open weights. You can implement A/B testing to evaluate model performance. For most applications, Claude Sonnet 4.5 (the default) is a great starting point.
</Accordion>

<Accordion title="What is the default model for new apps?">
  Claude Sonnet 4.5 is the default model for new apps in Playlab. It offers the best balance of intelligence, speed, and capability for most applications.
</Accordion>

<Accordion title="When should I choose Claude Sonnet 4.5 vs Claude 4.5 Opus vs Claude 4.5 Haiku?">
  Choose Claude Sonnet 4.5 (the default) for most applications where you need excellent intelligence with good speed. Choose Claude 4.5 Haiku for fast, lightweight tasks requiring quick response times. Choose Claude 4.5 Opus when you need the highest accuracy for complex, critical tasks where performance is more important than speed.
</Accordion>

<Accordion title="Should I upgrade from older Claude models?">
  Yes, Claude Sonnet 4.5 is the latest and smartest model in the Claude family, offering superior performance over all previous versions. Claude 4.5 Haiku is the fastest and most efficient Claude model. It's recommended to upgrade for most use cases. Claude 4.5 Opus is best for complex reasoning tasks requiring maximum capability.
</Accordion>

<Accordion title="What's the difference between Claude Sonnet 4.5, Claude 4.5 Haiku, and Claude 4.5 Opus?">
  Claude Sonnet 4.5 is the most advanced and balanced model, offering excellent intelligence and speed for most tasks (this is the default for new apps). Claude 4.5 Haiku is optimized for speed and efficiency, making it ideal for quick questions and lightweight tasks. Claude 4.5 Opus prioritizes maximum capability and accuracy for complex reasoning tasks that require the highest quality output, even if slower.
</Accordion>

<Accordion title="What's the difference between GPT 5, GPT 5 Mini, GPT 5 Nano, and GPT 5.1?">
  GPT 5.1 is OpenAI's latest coding and reasoning model with maximum performance. GPT 5 is the previous version. GPT 5 Mini provides a good balance of capabilities with faster response times. GPT 5 Nano is optimized for speed and high-volume applications while maintaining core improvements over previous generations.
</Accordion>
...
<Accordion title="When should I consider open weight models like Llama 4, Qwen3, or DeepSeek R1?">

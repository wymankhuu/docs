...
description: 'Choose the best fit AI model for your Playlab application'
---
...
<Accordion title="Try to match your model with your use case:">
  ...
  * Problem-solving tools – Select reasoning-focused models like Claude 3.7 Sonnet (Reasoning), Llama 4 Maverick, o3 Mini
  * Document analysis – Consider specialized models like Llama 4 Scout for multi-document or cross-lingual analysis
  * Educational explanation – Consider specialized models like Llama 3.3 70B Instruct, Llama 4 Maverick, or those with strong explanatory capabilities

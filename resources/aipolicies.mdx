...
<CardGroup cols={1}>
  <Card title="aiEDU" href="https://www.aiedu.org">
    <div className="flex items-center mb-4">
      <img src="/images/aiedulogo.webp" alt="aiEDU Logo" className="w-12 h-12 mr-3" />
    </div>
  ...
  <Card title="Throughline Learning" href="https://throughlinelearning.org/">
    <div className="flex items-center mb-4">
      <img src="/images/throughlinelogo.png" alt="Throughline Learning Logo" className="w-12 h-12 mr-3" />
    </div>
  ...
  <Card title="LEAP Innovations" href="https://www.leapinnovations.org">
    <div className="flex items-center mb-4">
      <img src="/images/leaplogo.webp" alt="LEAP Innovations Logo" className="w-12 h-12 mr-3" />
    </div>
